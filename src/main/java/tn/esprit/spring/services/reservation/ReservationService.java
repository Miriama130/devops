...
public class ReservationService implements IReservationService {
    ...
    public Reservation findById(String id) {
        return repo.findById(id).orElse(null); // Use orElse to handle Optional
    }
    ...
    public Reservation ajouterReservationEtAssignerAChambreEtAEtudiant(Long numChambre, long cin) {
        ...
        log.info("Number of reservations for the chamber: {}", numRes);
    ...
    public String annulerReservation(long cinEtudiant) {
        ...
        return "Aucune réservation valide trouvée pour l'étudiant avec CIN: " + cinEtudiant;
    }
